...
namespace CoreMailer.Models
{
    public class MailerModel
    {
        ...
        public bool HasLayout => !string.IsNullOrEmpty(Layout);
        ...
        public MailerModel(string pickupDirectory, string layout)
        {
            Layout = layout;
            ToAddresses = new List<string>();
            Attachments = new List<Attachment>();
        ...
        public MailerModel(string layout = "Shared/_EmailLayout.html")
        {
            Layout = layout;
            ToAddresses = new List<string>();
            Attachments = new List<Attachment>();
